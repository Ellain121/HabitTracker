...
public:
    Habit(const QString& name = "", const QDate& date = currentDate(),
    ...
    void loadDatesInfo(const QMap<QDate, int>& datesStatus);
    ...
    const QMap<QDate, int>& getDatesStatus() const;
    ...
    int                     getRepeatPatternSize() const;
